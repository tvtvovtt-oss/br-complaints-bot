...
# Заменяем ведущий 📌 на премиум-эмодзи (в тексте сообщений рендерится тегом
# <tg-emoji>, у не-премиум остаётся обычный 📌 как fallback).
RULES = {
    _k: (te(PE_TAG, "📌") + _v[1:] if _v.startswith("📌") else _v)
