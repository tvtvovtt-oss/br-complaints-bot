...
# Без эмодзи: на кнопках премиум-иконку рисует icon_custom_emoji_id, а эти
# подписи также используются как обычный текст в превью/истории.
COMPLAINT_CATEGORY_LABELS: dict[str, str] = {
    "players": "Жалоба на игрока",
    "admins":  "Жалоба на администрацию",
    "leaders": "Жалоба на лидера",
    "appeals": "Обжалование наказания",
    "technical": "Технический раздел",
    "tech_staff": "Жалоба на тех. специалиста",
}
