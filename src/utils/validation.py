...
_PROFANITY_WHITELIST_PREFIXES = (
    ...
    # Бан-действия — частое в жалобах («перебаньте», «забаньте»). Слог «еба»
    # в «перебанить» (пер-ЕБА-нить) иначе ловится корнем ложно.
    "перебан",   # перебанить, перебаньте, перебан
    "забан",     # забанить, забаньте
    "разбан",    # разбанить, разбан
    "отбан",     # отбанить
    "бан",       # бан, банить, банлист (не мат)
)
